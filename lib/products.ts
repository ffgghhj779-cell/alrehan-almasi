...
const FALLBACK_PRODUCTS: Product[] = [
  ...
  },
  {
    id: 8,
    sku: 'ARA-NUG-001',
    name: 'ستريبس دجاج أصلي 600g',
    category: 'مصنعات الدجاج',
    status: 'متوفر',
    image: '/assets/real/catalog/mfg_strips_original_bag.png',
    basePrice: 32,
    descriptionAr: 'ستريبس دجاج مقرمشة بقشرة الخضار من صدور سعودية طازجة، مجمدة وجاهزة للقلي أو القلاية الهوائية.',
    stockQuantity: 500,
    unitLabel: 'كيس',
    originCountry: 'المملكة العربية السعودية',
  ...
  },
  {
    ...
    basePrice: 24.5,
    descriptionAr: 'علبة شفافة تحتوي 30 بيضة بيضاء كبيرة درجة أولى، مثالية للجملة والتموين.',
    stockQuantity: 2200,
    unitLabel: 'علبة',
    originCountry: 'المملكة العربية السعودية',
    packaging: 'علبة شفافة 30 بيضة كبيرة',
  },
  {
    id: 16,
    sku: 'ARA-EGG-004',
