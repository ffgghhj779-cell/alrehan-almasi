...
(
  'ARA-RIC-002',
  'أرز مصري أبيض — شكارة 10 كجم',
  'الأرز',
  'متوفر',
  'https://images.unsplash.com/photo-1536304997881-8926e2c0c67a?w=900&q=85&auto=format&fit=crop',
  62.00,
  'أرز مصري أبيض قصير الحبة، مثالي للطبخ اليومي والمطاعم الاقتصادية والبوفيهات. ثبات في الطبخ وامتصاص متوازن للنكهات. التعبئة: شكارة 10 كجم.',
  290,
  'كيس',
  'مصر',
  'شكارة 10 كجم',
...
(
  'ARA-RIC-003',
  'أرز كالروز أمريكي — 20 كجم',
  'الأرز',
  'متوفر',
  'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=900&q=85&auto=format&fit=crop',
  98.00,
  'أرز كالروز متوسط الحبة من كalifornia، حبة لامعة وقوام معتدل. مثالي للأطباق الآسيوية والسوshi والمطابخ الفندقية. التعبئة: كرتون 20 كجم.',
  175,
  'كيس',
  'الولايات المتحدة',
  'كرتون 20 كجم',
...
-- ── لحوم & إضافيات (Premium add-ons) ─────────────────────────────────────
(
  'ARA-MET-001',
  'لحم غنم طازج — قطع مشكّلة',
  'اللحوم الطازجة',
  'عند الطلب',
  'https://images.unsplash.com/photo-1603048588665-791ca794ae1a?w=900&q=85&auto=format&fit=crop',
  135.00,
  'لحم غنم طازج بلدي، تقطيع حسب الطلب (مفروم، chops، shoulder). يُجهّز يومياً في مستودعات مبردة. مثالي للمطاعم الشرقية والبوفيهات. التعبئة: Vacuume 2-5 كجم.',
  45,
  'كجم',
  'المملكة العربية السعودية',
  'كيس Vacuume',
